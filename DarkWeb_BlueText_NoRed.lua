if (game:GetService("CoreGui")):FindFirstChild("DarkWebUe") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).DarkWebUe:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(0, 170, 255);
_G.Dark = Color3.fromRGB(10, 10, 15);
_G.Third = Color3.fromRGB(0, 120, 255);
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("DarkWebUe")).Enabled = not (game.CoreGui:FindFirstChild("DarkWebUe")).Enabled;
end);
...
function Update:StartLoad()
	...
	TitleLoader.Text = "DarkWebUe";
	TitleLoader.Font = Enum.Font.FredokaOne;
	TitleLoader.TextSize = 50;
	TitleLoader.TextColor3 = Color3.fromRGB(0, 170, 255);
	...
	DescriptionLoader.TextColor3 = Color3.fromRGB(0, 170, 255);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("DarkWebUe") then
			makefolder("DarkWebUe");
		end;
		if not isfolder("DarkWebUe/Library/") then
			makefolder("DarkWebUe/Library/");
		end;
		if not isfile(("DarkWebUe/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("DarkWebUe/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("DarkWebUe/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("DarkWebUe/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("DarkWebUe/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local DarkWebUe = Instance.new("ScreenGui");
	DarkWebUe.Name = "DarkWebUe";
	DarkWebUe.Parent = game.CoreGui;
	DarkWebUe.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = DarkWebUe;
	...
	NameHub.Parent = Top;
	NameHub.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
	...
	NameHub.Text = "DarkWebUe";
	NameHub.TextSize = 20;
	NameHub.TextColor3 = Color3.fromRGB(0, 170, 255);
	...
	SubTitle.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
	...
	CloseButton.ImageColor3 = Color3.fromRGB(0, 170, 255);
	...
	ResizeButton.ImageColor3 = Color3.fromRGB(0, 170, 255);
	...
	CloseSettings.ImageColor3 = Color3.fromRGB(0, 170, 255);
	...
	SettingsButton.ImageColor3 = Color3.fromRGB(0, 170, 255);
	...
	TitleSettings.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
	...
	TitleSettings.TextColor3 = Color3.fromRGB(0, 170, 255);
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.ImageColor3 = Color3.fromRGB(0, 170, 255);
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
	...
	function uitab:Tab(text, img)
		...
		IDK.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
		...
		function main:Button(text, callback)
			...
			ImageLabel.ImageColor3 = Color3.fromRGB(0, 170, 255);
			...
			ArrowRight.ImageColor3 = Color3.fromRGB(0, 170, 255);
			Black.Name = "Black";
			Black.Parent = Button;
		...
		function main:Toggle(text, config, desc, callback)
			...
			Title2.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			...
			ToggleImage.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
		...
		function main:Dropdown(text, option, var, callback)
			...
			DropTitle.Text = text;
			DropTitle.TextColor3 = Color3.fromRGB(0, 170, 255);
			...
			SelectItems.TextColor3 = Color3.fromRGB(0, 170, 255);
			...
			ArrowDown.ImageColor3 = Color3.fromRGB(0, 170, 255);
			...
			DropScroll.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			...
			for i, v in next, option do
				...
				Item.TextColor3 = Color3.fromRGB(0, 170, 255);
				Item.TextSize = 13;
		...
		function main:Slider(text, min, max, set, callback)
			...
			ValueText.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			...
			circlebar.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
		...
		function main:Textbox(text, disappear, callback)
			...
			TextboxLabel.TextColor3 = Color3.fromRGB(0, 170, 255);
			TextboxLabel.TextSize = 15;
			TextboxLabel.TextTransparency = 0;
			TextboxLabel.TextXAlignment = Enum.TextXAlignment.Left;
			RealTextbox.Name = "RealTextbox";
			RealTextbox.Parent = Textbox;
			RealTextbox.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
		...
		function main:Label(text)
			...
			ImageLabel.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			ImageLabel.BackgroundTransparency = 1;
			ImageLabel.ImageTransparency = 0;
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			...
			Sep1.RichText = true;
			Sep1.Text = "DarkWebUe<font color=\"rgb(0, 170, 255)\">DarkWebUe</font>";
			Sep1.TextColor3 = Color3.fromRGB(0, 170, 255);
			Sep1.TextSize = 14;
			Sep2.Name = "Sep2";
			Sep2.Parent = Seperator;
			Sep2.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			...
			Sep2.Text = text;
			Sep2.TextColor3 = Color3.fromRGB(0, 170, 255);
			Sep2.TextSize = 14;
			Sep3.Name = "Sep3";
			Sep3.Parent = Seperator;
			Sep3.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(0, 170, 255)\">DarkWebUe</font>DarkWebUe";
			Sep3.TextColor3 = Color3.fromRGB(0, 170, 255);
			Sep3.TextSize = 14;
		end;
		function main:Line()
			...
			Linee.BackgroundColor3 = Color3.fromRGB(0, 170, 255);
